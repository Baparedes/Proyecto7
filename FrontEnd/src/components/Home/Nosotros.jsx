    ...
    <Box>
      ...
      >
        ...
        >
          ...
          en proyectos de vistualización con tecnologías VMware, además provee
          los principales elementos que componen este tipo de proyectos, como
        ...
        >
          ...
          internacionales. Esto nos permite contar con una destreza en la
          práctica en destacados proyectos tecnológicos en el ámbito local.
        </Typography>
        {user && token ? (
          <Button
            variant="contained"
